...
import SEOHelmet from "../components/SEOHelmet.jsx"; // Importar el nuevo hook
...
const MapPage = () => {
  ...
  const mapSchema = {
    ...
    "@type": "Map",
    "name": "Mapa de Sensores Ambientales Zephy",
    "description": `Mapa interactivo con ${filteredLocations.length} sensores ambientales en Puerto Maldonado`,
    "provider": {
      "@type": "Organization",
      "name": "Zephy"
    }
